...
export default function PBRWallet({ signature }) {
    ...
    const handleCreatePBRWallet = () => {
        createTonWallet(metamaskSignature, address, chainNetwork, token)
    }
        ...
        <>
            {
                tonPbrWalletAddress === "TON wallet not linked" ? (
                    ...
                    <div className="flex items-center">
                        ...
                        <span className="mr-2">{tonPbrWalletAddress != "TON wallet not linked" ? `PBR Wallet:: ${tonPbrWalletAddress.slice(0, 6)}...${tonPbrWalletAddress.slice(-4)}` : '-'}</span>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="48" color="#000000" fill="none">
                            ...
                            <path d="M20.556 3.49612L11.0487 13.0586M20.556 3.49612C20.062 3.00151 16.7343 3.04761 16.0308 3.05762M20.556 3.49612C21.05 3.99074 21.0039 7.32273 20.9939 8.02714" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                        </a>
