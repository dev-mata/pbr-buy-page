...
export default function MobileHeader({  userDashboardData, refreshDashboardData  }) {
    ...
    return (
        <div className="flex text-black px-8 block md:hidden">
            {/* {walletInfo ? <Image src={walletInfo.icon} width={20} height={20} alt='wallet-network' className='mx-2' /> : <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#fffff" fill="none">
